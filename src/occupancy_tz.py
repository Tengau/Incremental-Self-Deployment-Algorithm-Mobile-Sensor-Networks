...
class OccupancyGrid:
    ...
    def __init__(self, map_size, config, map):
        """
        ...
        """
        self.config = config
        self.resolution = 5  # self.config["map"]["resolution"]
        self.probability = 0.7  # self.config["map"]["prob_occ"]
        self.log_prob_map = map
    ...
    def laser_sweep(self, xi, zi):
        ...
        """
        # TODO: need to change zi into our implementation
    ...
    def check_cells(self, xi, zi):
        ...
        """
        # TODO: need to chagne zi into our implementation
        ...
        for i in range(len(zi)):
            free = np.hstack(
                (free, self.bresenham_line(xi[0], xi[1], occ[0][i], occ[1][i]).T)
            )
